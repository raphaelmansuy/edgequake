...
Iteration focus: Observe environment-sensitive provider failures
...
The provider-switching suite still failed after the LM Studio fix, but now for a higher-signal reason: local credentials were leaking into provider auto-detection.
