...
Iteration focus: Act on environment cleanup hardening
...
Expanded the provider-switching cleanup helper to clear the whole provider-detection surface, including Gemini, Anthropic, Azure, HuggingFace, and OpenRouter keys.
