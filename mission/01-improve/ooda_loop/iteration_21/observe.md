...
Iteration focus: Act on the verification matrix
...
Executed the bounded verification plan and used each failure as a decision point instead of stopping at the first red test.
