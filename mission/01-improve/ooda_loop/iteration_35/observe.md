...
Using full struct initializers for ProcessingStats is more reliable than `default()` followed by scattered field mutation because the intended state is visible in one place.
