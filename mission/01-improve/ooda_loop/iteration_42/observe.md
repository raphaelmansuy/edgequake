...
Iteration focus: Observe workspace provider ingestion coverage
...
The workspace provider ingestion tests remained part of the selected compile-and-run matrix after the tenant-construction cleanup.
