...
Iteration focus: Observe library lint state after the targeted fixes

## Implemented / Verified

The remaining all-target lint debt was intentionally not treated as this mission slice unless it intersected the selected verification targets.
