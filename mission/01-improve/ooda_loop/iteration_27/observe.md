...
Iteration focus: Orient on provider contract comments
...
Provider tests need WHY comments when provider factories normalize dimensions or ignore caller-supplied sizes.
