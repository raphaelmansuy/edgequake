...
Prioritized four low-risk edits: simplify the error assertion, move lineage cache bounds to a const invariant, tighten PDF range assertions, and DRY the processor task fixtures.
