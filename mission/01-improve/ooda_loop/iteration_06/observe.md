...
A second lint pass exposed additional hygiene issues in API integration tests: unused imports, dead helpers, needless borrows, and default-then-reassign fixtures.
