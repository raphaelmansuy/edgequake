...
Iteration focus: Act on LM Studio contract alignment
...
Updated the LM Studio provider test to assert the verified 768-dimension contract and documented why the requested 384 value is ignored.
