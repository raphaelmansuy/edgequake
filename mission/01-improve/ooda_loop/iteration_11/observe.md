...
Iteration focus: Orient on provider-dimension truth
...
The provider stack already normalizes LM Studio embeddings to a 768-dimensional profile, so the failing test reflected an outdated assumption.
