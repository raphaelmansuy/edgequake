...
Iteration focus: Decide to keep direct provider-factory assertions
...
Retained direct factory assertions in ingestion tests because they surface provider misconfiguration earlier than end-to-end document uploads would.
