...
Iteration focus: Decide the verification matrix
...
Selected the exact edgequake-api targets that cover the modified areas: lib tests plus provider lineage, vector dimension, provider switching, documents, safety limits, dashboard stats, workspace provider ingestion, and document processing providers.
