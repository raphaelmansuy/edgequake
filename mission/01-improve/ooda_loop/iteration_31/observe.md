...
Iteration focus: Orient on request-builder maintainability
...
Needless borrows in `.uri(&format!(...))` are small, but they accumulate noise across test suites and make future diffs harder to scan.
