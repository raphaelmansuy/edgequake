...
Iteration focus: Decide the second patch batch
...
Selected the highest-impact E2E fixes: remove stale imports, replace needless borrows, make ProcessingStats initializers explicit, and clean document URI builders.
