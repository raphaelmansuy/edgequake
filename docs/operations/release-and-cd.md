...
> **Product: v0.26.6** · Contract: OpenAPI · Spec ops: [Ingestion cancel & fairness](../ingestion-cancel-and-fairness.md)
>
> Upgrade: [upgrade-to-0.26.6.md](upgrade-to-0.26.6.md) (SPEC-147 Vision figures, SPEC-119 delete discovery, Vision stall retry). Prior: [upgrade-to-0.26.5.md](upgrade-to-0.26.5.md) (SPEC-145 Langfuse complete I/O).
>
