...
<Card className="border-2 border-dashed border-muted-foreground/20 bg-muted/5">
  <CardContent className="flex flex-col items-center justify-center py-16 text-center">
    ...
    <h3 className="text-xl font-semibold mb-2">Upload Your First Document</h3>
    <p className="text-muted-foreground mb-6 max-w-md">
      Drag and drop files here, or click to browse. Supported formats: TXT, PDF,
      MD, DOCX.
    </p>
...
<Card>
  <CardHeader className="pb-3">
    ...
    <p className="text-xs text-muted-foreground mt-1">
      {completedFiles}/{uploadingFiles.length} completed •{" "}
...
**📌 Should Do (Next Sprint):** 5. Add right panel for document preview (R1) - 4-6 hours 6. Implement bulk selection (R8) - 3-4 hours 7. Improve batch upload progress (R9) - 2-3 hours 8. Add keyboard shortcuts - 2 hours

**💡 Nice to Have (Later):** 9. File type icons 10. Enhanced empty state illustrations 11. Pipeline status button in header 12. Active filter pills
