...
use edgequake_query::strategies::{
    create_strategy, NaiveStrategy, StrategyConfig, QueryStrategy,
};
...
async fn setup_graph_storage(num_nodes: usize, num_edges: usize) -> Arc<MemoryGraphStorage> {
    ...
    for i in 0..num_nodes {
        ...
        props.insert("description".to_string(), json!(format!("Entity {} description", i)));
