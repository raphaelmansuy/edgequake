...
def create_001_basic_text():
    ...
    # Simple paragraphs
    story.append(Paragraph("This is a simple test document with basic text content.", styles['Normal']))
...
def create_003_lists():
    ...
    # Numbered list
    for i, item in enumerate(["First numbered item", "Second numbered item", "Third numbered item"], 1):
...
def create_004_simple_table():
    ...
    story.append(Paragraph("This document contains a simple 2-column by 3-row table:", styles['Normal']))
    story.append(Spacer(1, 0.2*inch))
