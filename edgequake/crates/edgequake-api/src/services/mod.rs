...
pub use multimodal::{
    ...
    filter_mm_chunks_already_inlined, find_target_span, load_chunk_separators,
    load_content_rows_by_blockid_jsonl, load_manifest, load_mm_chunks, manifest_item_status_views,
    manifest_key, maybe_attach_cache_key, metadata_multimodal_patch, mm_asset_already_inlined,
    ...
    MmTextEnrichment, MultimodalChunk, MultimodalHeading, MultimodalItemRecord,
    MultimodalItemStatusView, MultimodalManifest, MultimodalProviders, MultimodalReanalyzeOutcome,
    MultimodalReanalyzeParams, MultimodalSummary, PromptContext, SurroundingContext,
    SurroundingKind, SurroundingTokenCounter, METADATA_FIELD,
};
