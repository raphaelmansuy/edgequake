...
use edgequake_llm::{OpenAIProvider, LLMProvider, EmbeddingProvider};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("✓ Embedding Provider: {} (model: {})", embedding.name(), embedding.model());
...
"#),
    ...
    println!("  • Entity deduplication: {}% ({}→{} nodes)",
