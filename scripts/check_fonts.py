...
reader = PdfReader('/Users/raphaelmansuy/Github/03-working/edgequake/zz_test_docs/Apple-Sandbox-Guide-v1.0.pdf')
...
for page_num in range(min(5, len(reader.pages))):
    ...
    for font_name, font_ref in fonts.items():
        ...
        print(f'  {font_name}: {base_font} - Encoding: {enc_info}')
