# 24 — Plan-19 Gap Closure (2026-06-26, rev.2)
...
| **P-G8-http**           | HTTP contract for Bypass + Mix                                                                                                         | `e2e_spec021_query_modes_http.rs`                                                    |
...
| **DRY**                 | `DefaultIngestionPersister::from_settings` in orchestrator, processor, trait parity test; batch merge                                  | persister + merger                                                                   |
...
cargo test -p edgequake-api --test e2e_spec021_query_modes_http
cargo test -p edgequake-api --test spec021_processor_cache_invalidator_contract
```
