...
**Medium Frequency** (15% of issues): 5. ⚠️ Quality score low → Interpretation guide 6. ⚠️ Empty pages skipped → Expected behavior explanation

**Low Frequency** (5% of issues): 7. ❌ Complex merged cells → Known limitation 8. ❌ Custom fonts → Advanced troubleshooting
