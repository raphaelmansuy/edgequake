...
The SDK was designed from API *documentation* (OpenAPI spec, type definitions). E2E testing against the *actual* backend revealed discrepancies between documented and actual behavior. This is expected — the SDK must ultimately conform to the running server, not static docs.
