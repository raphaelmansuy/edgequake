...
2. **Read:**
* *If < 300 lines:* Read the full file.
* *If > 300 lines (Distributed Sampling):*
...
* *Example:* `docs/api.md` -> `edgequake/backend/api/`
...
* *Tip:* Search for unique strings (variable names, exact error messages, route paths).
...
* *Precision:* If the code uses a specific variable name, reference it.
