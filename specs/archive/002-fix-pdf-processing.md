# Mission: Fix PDF Processing Pipeline E2E

## Task

Your mission is to test end-to-end PDF upload functionality in EdgeQuake using Playwright MCP browser automation, and ensure the complete pipeline works: PDF upload → Markdown conversion → Knowledge Graph extraction → Processing completion.

## Context

- **Location**: `/Users/raphaelmansuy/Github/03-working/edgequake`
- **Test File**: `zz-explore/AgenticPlatformReference Architecture.pdf`
...
1. **Re-read mission** every iteration: mission file `/Users/raphaelmansuy/Github/03-working/edgequake/specs/002-fix-pdf-processing.md`
...
1. PDF file uploads successfully via the WebUI
2. PDF is converted to Markdown
3. Entities are extracted to Knowledge Graph
