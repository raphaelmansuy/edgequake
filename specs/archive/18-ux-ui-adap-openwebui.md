...
- Ensure markdown rendering supports complex elements (tables, code blocks, mermaid, katex)
- Ensure streaming responses function correctly
- Ensure the markdown display is perfect and is consistent with openwebui's rendering
- Ensure micro-interactions are smooth and polished, enhancing SLICKness and MINIMALISM (becarful attention to loading states, error states, hover effects, etc. and animations in streaming mode)
