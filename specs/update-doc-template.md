...
|-----------|-------|----------|
| Frontend | [stack] | ./path/to/frontend/ |
| Backend | [stack] | ./path/to/backend/ |
...
### Phase 1: Inventory
*Gate*: **Inventory Gate** — Exit: every document is mapped to source or marked orphan. Owner: Documentation author.
...
### Phase 2: Analysis
*Gate*: **Analysis Gate** — Exit: each mapped source has at least one documented claim or an assigned gap. Owner: Documentation author + code reviewer.
...
### Phase 3: Archival
*Gate*: **Archival Gate** — Exit: files to archive are confirmed and cross-references handled. Owner: Documentation author + maintainer.
...
### Phase 4: Updates
*Gate*: **Update Gate** — Exit: documentation edits completed and examples validated; Owner: Documentation author (+ test verification by dev).
...
### Phase 5: Validation
*Gate*: **Validation Gate** — Exit: no unresolved findings, links valid, and basic lint passes. Owner: Documentation reviewer.
...
*Gate*: **Final Verification Gate** — Exit: per-file sign-off with zero mismatches. Owner: Documentation author + code owner.
