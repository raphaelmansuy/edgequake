  ...
  describe('mock backend response parsing', () => {
    it('parses realistic backend response', () => {
      const backendResponse = {
        ...
        phases: [
          { phase: 'Upload', status: 'complete', current: 1, total: 1, percentage: 100, message: 'File uploaded' },
          { phase: 'PdfConversion', status: 'active', current: 3, total: 5, percentage: 60, message: 'Converting page 3 of 5' },
          { phase: 'Chunking', status: 'pending', current: 0, total: 0, percentage: 0, message: '' },
          { phase: 'Embedding', status: 'pending', current: 0, total: 0, percentage: 0, message: '' },
          { phase: 'Extraction', status: 'pending', current: 0, total: 0, percentage: 0, message: '' },
          { phase: 'GraphStorage', status: 'pending', current: 0, total: 0, percentage: 0, message: '' },
        ],
    ...
    it('parses completed upload response', () => {
      const completedResponse = {
        ...
        phases: [
          { phase: 'Upload', status: 'complete', current: 1, total: 1, percentage: 100, message: 'Done' },
          { phase: 'PdfConversion', status: 'complete', current: 10, total: 10, percentage: 100, message: 'Done' },
          { phase: 'Chunking', status: 'complete', current: 25, total: 25, percentage: 100, message: 'Done' },
          { phase: 'Embedding', status: 'complete', current: 25, total: 25, percentage: 100, message: 'Done' },
          { phase: 'Extraction', status: 'complete', current: 45, total: 45, percentage: 100, message: 'Done' },
          { phase: 'GraphStorage', status: 'complete', current: 68, total: 68, percentage: 100, message: 'Done' },
        ],
        overall_percentage: 100,
        started_at: '2025-01-27T12:00:00.000Z',
