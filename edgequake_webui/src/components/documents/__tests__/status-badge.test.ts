...
describe('Status Configuration', () => {
  ...
  it('should have correct processing states', () => {
    const processingStates = ['processing', 'chunking', 'extracting', 'embedding', 'indexing'];
...
describe('Status Flow', () => {
  ...
  it('should detect processing to terminal transitions', () => {
    ...
    const processingStates: DocumentStatus[] = ['processing', 'chunking', 'extracting', 'embedding', 'indexing'];
    ...
    const terminalStates: DocumentStatus[] = ['completed', 'indexed', 'failed', 'cancelled'];
  ...
  it('should have mutually exclusive processing and terminal states', () => {
    const allStatuses: DocumentStatus[] = [
      'pending', 'processing', 'chunking', 'extracting', 
      'embedding', 'indexing', 'completed', 'indexed', 'failed', 'cancelled'
    ];
...
describe('Animation States', () => {
  ...
  it('should not animate non-processing states', () => {
    const nonProcessingStates: DocumentStatus[] = ['pending', 'completed', 'indexed', 'failed', 'cancelled'];
...
describe('Performance', () => {
  ...
  it('should normalize statuses quickly', () => {
    const start = performance.now();
    const statuses = ['pending', 'PROCESSING', 'Completed', 'unknown', null, undefined];
  ...
  it('should get stage progress quickly', () => {
    const start = performance.now();
    const statuses: DocumentStatus[] = ['chunking', 'extracting', 'embedding', 'indexing', 'pending'];
