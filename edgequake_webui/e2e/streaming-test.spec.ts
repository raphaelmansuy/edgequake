...
test.describe('Query Streaming Test', () => {
  test('should properly handle streaming text without concatenation issues', async ({ page }) => {
    ...
    await page.screenshot({ path: 'test-results/query-response.png', fullPage: true });
    ...
    const hasResponse = pageContent.includes('AI') || 
