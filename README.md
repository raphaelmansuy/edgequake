...
[![Version](https://img.shields.io/badge/version-0.26.6-blue.svg?style=flat)](CHANGELOG.md)
...
> Pin a version: `EDGEQUAKE_VERSION=0.26.6 sh quickstart.sh`
...
EDGEQUAKE_VERSION=0.26.6 EDGEQUAKE_POSTGRES_TAG=0.21.0-pg16 \
  docker compose -f docker-compose.quickstart.yml up -d
```
